 ...
 * @version 3.0.0 (Dark Header & Google Translate Fix)
 * @updated 2024-12-16
 */
...
const V5Layout = (() => {
    ...
    class LayoutManager {
        ...
        init() {
            ...
            console.log('[Layout] Initialized v3.0.0');
        }

        // --- 1. Header Rendering (优化重点) ---
        renderHeader() {
            ...
            container.innerHTML = `
                <nav id="navbar" class="fixed w-full z-50 bg-gradient-to-r from-blue-900 to-blue-800 shadow-lg transition-all duration-300">
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div class="flex justify-between items-center h-20">
                            <a href="index.html" class="flex items-center gap-3 group">
                                <img src="${logoSrc}" onerror="this.onerror=null; this.src='${logoFallback}';" class="h-10 w-auto transition-transform group-hover:scale-105 brightness-0 invert" alt="${this.config.SEO.SITE_NAME}">
                                <div>
                                    <div class="font-bold text-xl text-white leading-none">V5 Medical LTD</div>
                                    <div class="text-[10px] text-blue-200 font-medium tracking-wider uppercase mt-0.5">Global Medical Supply Chain</div>
                                </div>
                            </a>
                            ...
                            <button id="mobile-menu-btn" class="md:hidden text-white p-2 hover:bg-white/10 rounded-lg transition"><i class="fas fa-bars text-2xl"></i></button>
                        </div>
                    </div>
        ...
        _getActiveClass(id) { return this.currentPage === id ? 'text-blue-900 font-bold' : 'text-gray-600 hover:text-blue-900'; }
