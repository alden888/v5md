...
ax.text(0.5, 0.06, "v5md.com  |  ISO 13485 Certified Supply Chain  |  Factory-direct from China",
...
ax.text(0.5, 0.045, "v5md.com  |  Anti-counterfeit packaging for Southeast Asia pharmaceutical markets",
        ha="center", fontsize=9.5, color=MUTED)
